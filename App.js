...
db.transaction(
  tx => {
    tx.executeSql("INSERT INTO continents VALUES('European Union',446946712,21.7,90.98,100,80,38234.1)");
    tx.executeSql("INSERT INTO continents VALUES('Africa',1416625724,34,71,43,64.38,4121)");
    tx.executeSql("INSERT INTO continents VALUES('Àsia',4598168800,27.5,84,97,79,13037.5)");
